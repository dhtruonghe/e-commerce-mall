<%-- 
    ...
    Created on : Oct 8, 2024, 7:40:38 AM
    Author     : haitr
--%>
        ...
        <form action="ProductURL" method="post">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="Discontinued" id="Discontinued" 
                               value="0" <%=(product.isDiscontinued() == true ? "checked" : "")%>>Discontinued
                        <input type="radio" name="Discontinued" id="Discontinued" 
                               value="1" <%=(product.isDiscontinued() == false ? "checked" : "")%>>Continued
                    </td>   
